...
<html lang="zh-CN">
  <head>
    ...
    <!-- 以相对路径+后缀来对其他资源文件进行相应的配置,以此来解决相对路径失效的问题 -->
...
h3.break>a {
  ...
  <!-- 
  	被服务器解析的路径：绝对路径基准地址到项目  http://localhost:8080/项目名
  		web.xml中的路径
  		转发
  		jsp动作标签
  	被浏览器解析的路径： 绝对路径基准地址到服务器：  http://localhost:8080
  		重定向
  		html标签内的所有的地址+js中使用的地址
   -->
      ...
      <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse" style="float:right;">
              <ul class="nav navbar-nav navbar-right">
                ...
                <li><a href="${PATH }/reg.html">注册</a></li>
              </ul>
            </div>
			  </div>
			</nav>

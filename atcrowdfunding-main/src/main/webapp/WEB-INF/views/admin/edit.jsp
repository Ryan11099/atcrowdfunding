			  ...
			  <div class="panel-body">
				<form role="form" action="${PATH }/admin/updateAdmin" method="post">
				   ...
				   <div class="form-group">
					...
					<input type="text" name="loginacct" class="form-control" id="exampleInputPassword1" value="${requestScope.editAdmin.loginacct }">
				  </div>
				  <div class="form-group">
					<label for="exampleInputPassword1">用户名称</label>
					<input type="text" name="username" class="form-control" id="exampleInputPassword1" value="${requestScope.editAdmin.username }">
				  </div>
				  <div class="form-group">
					<label for="exampleInputEmail1">邮箱地址</label>
					<input type="email" name="email" class="form-control" id="exampleInputEmail1" value="${requestScope.editAdmin.email }">
